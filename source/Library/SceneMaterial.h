...
namespace Library
{
	namespace BSPEngine {
		...
		struct SceneMaterialVertex
		{
			...
			SceneMaterialVertex(XMFLOAT3 position, XMFLOAT3 texcoords, 
			...
			bool same(const SceneMaterialVertex &vertex) const;
		};
		...
		class SceneMaterial
		{
			public:
				...
				void SetLeafDataView(ID3D11DeviceContext* deviceContext, ID3D11ShaderResourceView* leafDataView);
